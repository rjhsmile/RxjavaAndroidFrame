...
import com.example.jh.taokelink.net.progress.ProgressCancelListener;
import com.example.jh.taokelink.net.progress.ProgressDialogHandler;
import com.example.jh.taokelink.net.request.BaseRespond;
 ...
 * @author Veken
 */
public abstract class ResponseObserver<T extends BaseRespond> implements Observer<T>,ProgressCancelListener {
    private Context context;
    private ProgressDialogHandler mProgressDialogHandler;
    //取消订阅
    private Disposable mDisposable;

    public ResponseObserver(Context context, boolean isShowLoading) {
